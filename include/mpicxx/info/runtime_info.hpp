/**
 * @file include/mpicxx/info/runtime_info.hpp
...
// TODO 2020-05-18 01:35 breyerml: better name
namespace mpicxx {

    // TODO 2020-05-18 01:49 breyerml: add doxygen section
    /**
     * @brief Returns the maximum possible number of processes.
     * @return an optional containing the maximum possible number of processes or
     * [`std::nullopt`](https://en.cppreference.com/w/cpp/utility/optional/nullopt) if no value could be retrieved (`[[nodiscard]]`)
     *
     ...
     * }
     */
    [[nodiscard]] inline std::optional<int> universe_size() {
        void* ptr;
        int flag;
     ...
     * @return the name of the processor this code is running on (`[[nodiscard]]`)
     *
     * @calls{
     * int MPI_Get_processor_name(char *name, int *resultlen);      // exactly once
     * }
     */
    [[nodiscard]] inline std::string processor_name() {
